...
nrepetations = int(sys.argv[5]) if len(sys.argv) > 6 else 4
...
for i in range(nruns):
	...
	for num_procs in range(1,nprocs+1):
		...
		os.system("python3 -m da /home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/ramutex.da " + str(num_procs) + " " + str(nrequests))
...
for i in range(nruns):
	...
	for num_req in range(1,nrequests+1):
		...
		os.system("python3 -m da /home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/ramutex.da " + str(nprocs) + " " + str(num_req))
...
for s in range(nruns_c):
	...
	for numRequests in range(1,nrequests+1):
		...
		for m in range(1,nrepetations+1):
			...
			os.system("python3 -m da /home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/ramutex.da " + str(nprocs) + " " + str(numRequests))
...
RTFile = open("/home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/RT_varyReq",'w+')
CTFile = open("/home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/CT_varyReq",'w+')
...
for s in range(nruns_c):
	...
	for num_proc in range(1,nprocs+1):
		...
		for m in range(nrepetations):
			...
			os.system("python3 -m da /home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/ramutex.da " + str(num_proc) + " " + str(nrequests))
...
RTFile = open("/home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/RT_varyProc",'w+')
CTFile = open("/home/santosh/AsyncSystems/DistAlgo-1.0.0b14/examples/ramutex/CT_varyProc",'w+')
